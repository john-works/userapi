...
class CreateOfficersCompetencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('officers_competences', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('officers_competences');
    }
}
