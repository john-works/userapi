...
class CreateSupportStaffCompetencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('support_staff_competences', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('support_staff_competences');
    }
}
