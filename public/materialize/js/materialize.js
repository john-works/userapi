                ...
                if ( dontGiveFocus !== false ) {
                    ...
                    $document.on( 'click.' + STATE.id + ' focusin.' + STATE.id, function( event ) {
                        ...
                        if ( target != ELEMENT && target != document && event.which != 3 ) {
                           ...
                           //timothy P.close( target === P.$root.children()[0] )
                        }
