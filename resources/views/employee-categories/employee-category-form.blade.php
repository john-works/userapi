...
@section('title')
    Admin | Create Employee Category
@endsection
    ...
    <div class="row">
        ...
        <div class=" card-panel col l6 offset-l3">
            ...
            <div id="register" class="col s12">
                ...
                <form class="col s12" method="post" action="{{route('employee-categories.store')}}">

                    <div class="form-container">

                        <h5 class=""><i class="material-icons right blue-text text-darken-4">add_circle_outline</i>Add Employee Category</h5>

                        <div class="row">
                            <div class="input-field col m7 s12">
                                <input id="category" name="category" type="text" class="validate" required value="{{old('category')}}">
                                <label for="category">Category</label>
                            </div>
                            <div class="input-field col m5 s12">
                                <input id="category_code" name="category_code" type="text" class="validate" required value="{{old('category_code')}}">
