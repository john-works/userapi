			...
			<div class="form-group">
			  ...
			  <div class="input-group">
				<select class="form-control" id="calendarSelector" onchange="switchCalendar()">
					...
					{{-- Selected if department code and name match department for the trusted user --}}
					<option @if($calendar->department_code == $department->department_code) selected @endif value="{{ $calendar->department_code }}">
						{{ $calendar->department_name }}
					</option>
					@endforeach
