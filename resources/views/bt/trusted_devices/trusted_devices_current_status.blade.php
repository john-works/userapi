                                ...
                                <div class="panel-collapse" id="according_child_1" aria-expanded="false">
                                    <div class="panel-body">
                                        ...
                                        <div class="" style="width: 100%">
                                            <table class="data-table trusted_devices_current_details {{$trustedDevice->id}} table table-striped table-bordered table-hover no-margin-bottom no-border-top hide-first-column">
