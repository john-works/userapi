<div id="modal_competence_cat_edit" class="modal custom-fields modal-for-ajax-data">

    <div class="modal-content">

        <div  class="col s12">

            <form class="col s12" id="form_modal_competence_cat_edit" method="post" action="{{route('admin.behavioral-competence-categories.update')}}">
                ...
                <div class="form-container">
                    ...
                    <div class="center timo-form-headers">Competence Category</div>
