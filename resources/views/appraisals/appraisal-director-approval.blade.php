...
@section('title')
    {{config('app.name')}} | Director Approvals
@endsection
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title grey-text text-darken-1 ">DIRECTOR APPROVALS<span class="grey-text text-darken-1 "  style="font-size: small" >&nbsp;Assigned to you</span></h5>
                                    ...
                                    @if(isset($appraisals) && count($appraisals)>0)
                                        ...
                                        @foreach($appraisals as $appraisal)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$appraisal->executiveDirectorSubmissionDate}}</td>
