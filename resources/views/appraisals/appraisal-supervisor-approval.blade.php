...
@section('title')
    {{config('app.name')}} | Supervisor Approval
@endsection
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title grey-text text-darken-1 ">SUPERVISOR APPROVALS<span class="grey-text text-darken-1 "  style="font-size: small" >&nbsp;assigned to you</span></h5>
                                    ...
                                    @if(isset($appraisals) && count($appraisals)>0)
                                        ...
                                        @foreach($appraisals as $appraisal)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$appraisal->supervisorSubmissionDate}}</td>
